...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const contentSecurityPolicy = [
      ...
      "img-src 'self' data: https://covers.openlibrary.org https://*.archive.org https://archive.org https://*.us.archive.org https://images.unsplash.com https://m.media-amazon.com https://images-na.ssl-images-amazon.com https://*.gr-assets.com https://i.gr-assets.com",
